...
for config in PAR2:
    ...
    print(f"  Release Rule: {RELEASE_RULE}, Worker Mode: {WORKER_MODE}, Starvation: {STARVATION_AVOIDANCE}")
    print(f"  Constraint Scenario: {CONSTRAINT_SCENARIO}, Absenteeism: {ABSENTEEISM_LEVEL}")
    print(f"  Shop Flow: {SHOP_FLOW}, Shop Length: {SHOP_LENGTH}")
    print("------------------------")
